...
otp_Platform_lookupClass = var$1 => {
    switch ($rt_ustr(var$1)) {
        ...
        case "uk.co.instanto.client.service.EventBus$addTransport$lambda$_1_0": ucics_EventBus$addTransport$lambda$_1_0.$clinit(); return ucics_EventBus$addTransport$lambda$_1_0;
        ...
        case "uk.co.instanto.client.service.proto.EventPacket": ucicsp_EventPacket.$clinit(); return ucicsp_EventPacket;
        ...
        case "uk.co.instanto.client.service.transport.LocalTransport": ucicst_LocalTransport.$clinit(); return ucicst_LocalTransport;
        ...
        case "uk.co.instanto.client.service.dto.proto.NodeAnnouncedEvent": ucicsdp_NodeAnnouncedEvent.$clinit(); return ucicsdp_NodeAnnouncedEvent;
        ...
        case "uk.co.instanto.client.service.EventBus$subscribe$lambda$_4_0": ucics_EventBus$subscribe$lambda$_4_0.$clinit(); return ucics_EventBus$subscribe$lambda$_4_0;
        ...
        case "uk.co.instanto.integration.browser.BrowserEventBusTest": uciib_BrowserEventBusTest.$clinit(); return uciib_BrowserEventBusTest;
        ...
        case "uk.co.instanto.client.service.proto.EventPacket$Builder": ucicsp_EventPacket$Builder.$clinit(); return ucicsp_EventPacket$Builder;
        ...
        case "uk.co.instanto.integration.browser.BrowserEventBusTest$1": uciib_BrowserEventBusTest$1.$clinit(); return uciib_BrowserEventBusTest$1;
        ...
        case "uk.co.instanto.client.service.dto.proto.NodeAnnouncedEvent$Builder": ucicsdp_NodeAnnouncedEvent$Builder.$clinit(); return ucicsdp_NodeAnnouncedEvent$Builder;
        ...
        case "uk.co.instanto.client.service.EventBus": ucics_EventBus.$clinit(); return ucics_EventBus;
        ...
        case "uk.co.instanto.client.service.EventHandler": ucics_EventHandler.$clinit(); return ucics_EventHandler;
        ...
        case "uk.co.instanto.client.service.dto.proto.NodeAnnouncedEvent$ProtoAdapter_NodeAnnouncedEvent": ucicsdp_NodeAnnouncedEvent$ProtoAdapter_NodeAnnouncedEvent.$clinit(); return ucicsdp_NodeAnnouncedEvent$ProtoAdapter_NodeAnnouncedEvent;
...
"UTF-8", "asList(...)", "destination", "copyOfRange(...)", " ", "expected: ", " but was: ", "expected:<", "> but was:<", ">", "<", "list", ", ", "type.googleapis.com/google.protobuf.ListValue", "segment", "byteCount out of range", "cannot compact", "only owner can write", "Failed requirement.", "uk.co.instanto.integration.browser.BrowserEventBusTest.testEventBusWithProtoInBrowser()V", "Invalid test name", "Unexpected call to beginMessage()", "Wire recursion limit exceeded", "Unexpected call to endMessage()",
...
".", ", parameter ", "PROTO_2", "proto2", "PROTO_3", "proto3", "type.googleapis.com/google.protobuf.Timestamp", "type.googleapis.com/uk.co.instanto.client.service.proto.EventPacket", "event.proto", "immutableList", "null cannot be cast to non-null type java.util.ArrayList<T of com.squareup.wire.internal.MutableOnWriteList>", "mode", "Step is zero.", "type.googleapis.com/google.protobuf.Value", "null cannot be cast to non-null type kotlin.collections.Map<kotlin.String, *>", "unexpected struct value: ", "type.googleapis.com/uk.co.instanto.client.service.dto.proto.NodeAnnouncedEvent",
