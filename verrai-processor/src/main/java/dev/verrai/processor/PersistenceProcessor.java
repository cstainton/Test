...
import dev.verrai.api.persistence.*;
...
@SupportedAnnotationTypes({
    "dev.verrai.api.persistence.Entity",
...
public class PersistenceProcessor extends AbstractProcessor {
    ...
    private String generateMapper(TypeElement entity) throws IOException {
        ...
        ClassName entityMapperInterface = ClassName.get("dev.verrai.persistence", "EntityMapper");
    ...
    private void generateAppEntityManager(TypeElement entryPoint) throws IOException {
        ...
        ClassName entityManagerImpl = ClassName.get("dev.verrai.persistence", "EntityManagerImpl");
        ClassName defaultPersistenceUnit = ClassName.get("dev.verrai.persistence", "DefaultPersistenceUnit");
    ...
    private void generateServiceFile() throws IOException {
        FileObject file = filer.createResource(StandardLocation.CLASS_OUTPUT, "", "META-INF/services/dev.verrai.persistence.EntityMapper");
