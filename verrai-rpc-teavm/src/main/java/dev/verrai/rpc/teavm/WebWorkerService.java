...
public class WebWorkerService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(WebWorkerService.class);

    private final JSObject worker;
    private final Map<Class<?>, Codec<?, ?>> codecRegistry = new HashMap<>();

    public WebWorkerService(JSObject worker) {
        this.worker = worker;
    ...
    public void handleMessage(MessageEvent event) {
        ...
        if (isUint8Array(data)) {
            ...
            try {
                ...
                // Handle response...
                logger.info("Received RPC response for: {}", packet.requestId);
            } catch (Exception e) {
                logger.error("Error decoding RPC packet", e);
            }
        }
    }
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            if (args != null && args.length > 0) {
                ...
                if (arg instanceof Message) {
                    ...
                    logger.warn("Unsupported argument type: {}", arg.getClass());
                }
            }
