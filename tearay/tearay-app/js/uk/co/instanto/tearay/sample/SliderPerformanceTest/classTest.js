...
(function(root, module) {
    ...
    function ucits_SliderPerformanceTest() {
        jl_Object.call(this);
        this.$callCount = 0;
    }
    function ucits_SliderPerformanceTest__init_() {
        var var_0 = new ucits_SliderPerformanceTest();
        ucits_SliderPerformanceTest__init_0(var_0);
        return var_0;
    }
    function ucits_SliderPerformanceTest__init_0($this) {
        jl_Object__init_0($this);
        $this.$callCount = 0;
    }
    function ucits_SliderPerformanceTest_testRedundantEventListeners($this) {
        var $slider, $inputEvent, $changeEvent;
        $slider = ucitw_Slider__init_();
        $this.$callCount = 0;
        $slider.$addChangeHandler(ucits_SliderPerformanceTest$testRedundantEventListeners$lambda$_2_0__init_($this));
        $inputEvent = new $rt_globals.Event("input");
        $slider.$element.dispatchEvent($inputEvent);
        $changeEvent = new $rt_globals.Event("change");
        $slider.$element.dispatchEvent($changeEvent);
        oj_Assert_assertEquals($rt_s(0), Long_fromInt(1), Long_fromInt($this.$callCount));
    }
    function ucits_SliderPerformanceTest_lambda$testRedundantEventListeners$0($this, $e) {
    ...
    function jl_Long_toString($value) {
        jl_Long_$callClinit();
        return $rt_nullCheck((jl_StringBuilder__init_()).$append1($value)).$toString();
    }
    function jl_Long_toString0($this) {
        return jl_Long_toString($this.$value);
    }
    ...
    function otj_TestEntryPoint$LauncherImpl0_launch(var$0, var$1) {
        ucits_SliderPerformanceTest_testRedundantEventListeners($rt_nullCheck($rt_castToClass(var$1, ucits_SliderPerformanceTest)));
    }
    ...
    function otj_TestEntryPoint_createTestCase() {
        return ucits_SliderPerformanceTest__init_();
    }
    function otj_TestEntryPoint_before() {}
    function otj_TestEntryPoint_launchers(var$1, var$2) {
        if (!jl_String_equals($rt_nullCheck(var$1), $rt_s(3)))
    ...
    function ucits_SliderPerformanceTest$testRedundantEventListeners$lambda$_2_0() {
        jl_Object.call(this);
        this.$_0 = null;
    }
    function ucits_SliderPerformanceTest$testRedundantEventListeners$lambda$_2_0__init_(var_0) {
        var var_1 = new ucits_SliderPerformanceTest$testRedundantEventListeners$lambda$_2_0();
        ucits_SliderPerformanceTest$testRedundantEventListeners$lambda$_2_0__init_0(var_1, var_0);
        return var_1;
    }
    function ucits_SliderPerformanceTest$testRedundantEventListeners$lambda$_2_0__init_0(var$0, var$1) {
        jl_Object__init_0(var$0);
        var$0.$_0 = var$1;
    }
    function ucits_SliderPerformanceTest$testRedundantEventListeners$lambda$_2_0_handleEvent(var$0, var$1) {
        ucits_SliderPerformanceTest_lambda$testRedundantEventListeners$0($rt_nullCheck(var$0.$_0), var$1);
    }
    function ucits_SliderPerformanceTest$testRedundantEventListeners$lambda$_2_0_handleEvent$exported$0(var$0, var$1) {
    ...
    function otji_JSWrapper_wrap($o) {
        ...
        $isObject = !$type.$equals($rt_s(6)) && !$type.$equals($rt_s(7)) ? 0 : 1;
    ...
    function otj_TestJsEntryPoint_printStackTrace($e, $stream) {
        ...
        if ($message !== null) {
            var$3 = jl_StringBuilder__init_();
            jl_StringBuilder_append($rt_nullCheck(jl_StringBuilder_append(var$3, $rt_s(13))), $message);
            $stream.$append8(jl_StringBuilder_toString(var$3));
        }
        a: {
            $stream.$append8($rt_s(14));
            ...
            if ($stackTrace !== null) {
                ...
                while (true) {
                    ...
                    $element = var$6[var$8];
                    $stream.$append8($rt_s(15));
                    $rt_nullCheck($stream.$append($element)).$append8($rt_s(14));
                    var$8 = var$8 + 1 | 0;
                }
            }
        }
        if ($e.$getCause() !== null && $e.$getCause() !== $e) {
            $stream.$append8($rt_s(16));
    ...
    function oj_Assert_assertEquals($message, $expected, $actual) {
        if (Long_ne($expected, $actual))
            oj_Assert_failNotEquals($message, jl_Long_valueOf($expected), jl_Long_valueOf($actual));
    }
    ...
    function oj_Assert_format($message, $expected, $actual) {
        ...
        $formatted = $rt_s(17);
        if ($message !== null && !$rt_s(17).$equals($message))
            $formatted = $rt_nullCheck($rt_nullCheck((jl_StringBuilder__init_()).$append8($message)).$append8($rt_s(18))).$toString();
        ...
        if (oj_Assert_equalsRegardingNull($expectedString, $actualString))
            return $rt_nullCheck($rt_nullCheck($rt_nullCheck($rt_nullCheck($rt_nullCheck((jl_StringBuilder__init_()).$append8($formatted)).$append8($rt_s(19))).$append8(oj_Assert_formatClassAndValue($expected, $expectedString))).$append8($rt_s(20))).$append8(oj_Assert_formatClassAndValue($actual, $actualString))).$toString();
        return $rt_nullCheck($rt_nullCheck($rt_nullCheck($rt_nullCheck($rt_nullCheck($rt_nullCheck((jl_StringBuilder__init_()).$append8($formatted)).$append8($rt_s(21))).$append8($expectedString)).$append8($rt_s(22))).$append8($actualString)).$append8($rt_s(23))).$toString();
    }
    function oj_Assert_formatClassAndValue($value, $valueString) {
        ...
        return $rt_nullCheck($rt_nullCheck($rt_nullCheck($rt_nullCheck((jl_StringBuilder__init_()).$append8($className)).$append8($rt_s(24))).$append8($valueString)).$append8($rt_s(23))).$toString();
    }
    ...
    ucits_SliderPerformanceTest, 0, jl_Object, [], 0, 3, 0, 0, ["$_init_", $rt_wrapFunction0(ucits_SliderPerformanceTest__init_0), "$testRedundantEventListeners", $rt_wrapFunction0(ucits_SliderPerformanceTest_testRedundantEventListeners)],
    ...
    jl_Exception, 0, jl_Throwable, [], 0, 3, 0, 0, ["$_init_", $rt_wrapFunction0(jl_Exception__init_0), "$_init_1", $rt_wrapFunction1(jl_Exception__init_2)],
    jl_RuntimeException, 0, jl_Exception, [], 0, 3, 0, 0, ["$_init_", $rt_wrapFunction0(jl_RuntimeException__init_1), "$_init_1", $rt_wrapFunction1(jl_RuntimeException__init_2)],
    ...
    jl_NullPointerException, "NullPointerException", 2, jl_RuntimeException, [], 0, 3, 0, 0, ["$_init_1", $rt_wrapFunction1(jl_NullPointerException__init_1), "$_init_", $rt_wrapFunction0(jl_NullPointerException__init_2)],
    ...
    jl_Error, 0, jl_Throwable, [], 0, 3, 0, 0, ["$_init_", $rt_wrapFunction0(jl_Error__init_0), "$_init_1", $rt_wrapFunction1(jl_Error__init_2)],
    jl_LinkageError, 0, jl_Error, [], 0, 3, 0, 0, ["$_init_1", $rt_wrapFunction1(jl_LinkageError__init_0)],
    jl_IncompatibleClassChangeError, 0, jl_LinkageError, [], 0, 3, 0, 0, ["$_init_1", $rt_wrapFunction1(jl_IncompatibleClassChangeError__init_0)],
    jl_NoSuchFieldError, 0, jl_IncompatibleClassChangeError, [], 0, 3, 0, 0, ["$_init_1", $rt_wrapFunction1(jl_NoSuchFieldError__init_0)],
    ...
    ucits_SliderPerformanceTest$testRedundantEventListeners$lambda$_2_0, 0, jl_Object, [otjde_EventListener], 0, 3, 0, 0, ["$_init_0", $rt_wrapFunction1(ucits_SliderPerformanceTest$testRedundantEventListeners$lambda$_2_0__init_0), "$handleEvent", $rt_wrapFunction1(ucits_SliderPerformanceTest$testRedundantEventListeners$lambda$_2_0_handleEvent), "$handleEvent$exported$0", $rt_wrapFunction1(ucits_SliderPerformanceTest$testRedundantEventListeners$lambda$_2_0_handleEvent$exported$0)],
    ...
    jl_StackTraceElement, 0, jl_Object, [ji_Serializable], 4, 3, 0, 0, ["$_init_10", $rt_wrapFunction4(jl_StackTraceElement__init_0), "$toString", $rt_wrapFunction0(jl_StackTraceElement_toString)],
    jl_String, 0, jl_Object, [ji_Serializable, jl_Comparable, jl_CharSequence], 0, 3, 0, jl_String_$callClinit, ["$_init_", $rt_wrapFunction0(jl_String__init_2), "$_init_3", $rt_wrapFunction1(jl_String__init_3), "$_init_6", $rt_wrapFunction3(jl_String__init_4), "$charAt", $rt_wrapFunction1(jl_String_charAt), "$length0", $rt_wrapFunction0(jl_String_length), "$isEmpty", $rt_wrapFunction0(jl_String_isEmpty), "$lastIndexOf0", $rt_wrapFunction2(jl_String_lastIndexOf), "$lastIndexOf", $rt_wrapFunction1(jl_String_lastIndexOf0),
    ...
    jl_NoSuchMethodError, 0, jl_IncompatibleClassChangeError, [], 0, 3, 0, 0, ["$_init_1", $rt_wrapFunction1(jl_NoSuchMethodError__init_0)],
    ...
    jl_IllegalArgumentException, "IllegalArgumentException", 2, jl_RuntimeException, [], 0, 3, 0, 0, ["$_init_", $rt_wrapFunction0(jl_IllegalArgumentException__init_1), "$_init_1", $rt_wrapFunction1(jl_IllegalArgumentException__init_2)],
    otj_TestJsEntryPoint, 0, jl_Object, [], 4, 0, 0, 0, 0,
    ucitw_Slider, 0, ucitw_Widget, [], 0, 3, 0, 0, ["$_init_", $rt_wrapFunction0(ucitw_Slider__init_0), "$addChangeHandler", $rt_wrapFunction1(ucitw_Slider_addChangeHandler)],
    ...
    $rt_stringPool(["Listener should be called once (optimized behavior)", "Either src or dest is null", "0", "uk.co.instanto.tearay.sample.SliderPerformanceTest.testRedundantEventListeners()V", "Invalid test name", "null", "object", "function", "string", "number", "undefined", "Unknown Source", ")", ": ", "\n", "\tat ", "Caused by: ", "", " ", "expected: ", " but was: ", "expected:<", "> but was:<", ">", "<"]);
    ...
    (function() {
        var c;
        c = ucits_SliderPerformanceTest$testRedundantEventListeners$lambda$_2_0.prototype;
